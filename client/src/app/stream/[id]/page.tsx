...
const streamData: Record<string, any> = {
    ...
    "3": {
        ...
        viewers: 1856,
        category: "Technology",
        description: "Exploring WebRTC protocols, STUN/TURN servers, and building peer-to-peer connections for real-time communication.",
    ...
    "4": {
        ...
        viewers: 2145,
        category: "Web Dev",
        description: "Learn advanced React optimization techniques including memoization, code splitting, and virtual DOM optimization.",
    ...
    "5": {
        ...
        viewers: 1278,
        category: "Database",
        description: "Exploring database design patterns, normalization, indexing strategies, and query optimization techniques.",
        startedAt: "2024-02-02T19:15:00Z",
        streamType: "data",
        isAI: true,
    },
    "6": {
        title: "UI/UX Design - Modern Web Interfaces",
        streamer: "DesignGuru",
        viewers: 1892,
        category: "Design",
        description: "Creating beautiful, modern web interfaces with focus on user experience, accessibility, and visual design.",
